...
def compute_posterior(prior, likelihood, y):
    ...
    # -------------------------------------------------------------------------
    # Code to compute the log of the posterior here: store it in a
    # NumPy array called `log_answer`. If one exponentiates really small
...
def infer_true_movie_ratings(num_observations=-1):
    ...
    # -------------------------------------------------------------------------
    #
    # The code should iterate through the movies. For each movie, the code
    # should:
